...
import view.swing.cars.CarListView;
...
public class MainView extends JFrame {
	...
	public MainView() {
        setTitle("Concessionaria CRUD - Swing");
        ...
        JMenuItem carsListItem = new JMenuItem("Listar Carros");
        carsListItem.addActionListener(e -> new CarListView(this).setVisible(true));
        carMenu.add(carsListItem);
        menuBar.add(carMenu);
